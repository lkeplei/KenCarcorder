...
#import "KenFirstStepVC.h"
#import "Masonry.h"

@interface KenFirstStepVC ()

@end

@implementation KenFirstStepVC
...
- (void)viewDidLoad {
    ...
    UILabel *label = [UILabel labelWithTxt:@"第一步 准备行车记录仪" frame:(CGRect){0,0,top.size}
    ...
    UILabel *label2 = [UILabel labelWithTxt:@"蓝灯闪烁" frame:CGRectZero
    ...
    UIButton *button = [UIButton buttonWithImg:@"确认蓝灯已经闪烁" zoomIn:NO image:[UIImage imageNamed:@"wifi_1_btn"]
...
- (void)confirmBtnClicked {
    [self pushViewControllerString:@"KenWifiSetStep2VC" animated:YES];
}
